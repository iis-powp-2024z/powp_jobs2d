package edu.kis.powp.jobs2d.lines.decorators;

import edu.kis.legacy.drawer.shape.ILine;

import java.awt.*;

public class LineColorDecorator implements ILine {
    private final ILine line;
    private final Color color;

    public LineColorDecorator(ILine line, Color color) {
        this.line = line;
        this.color = color;
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        return new LineColorDecorator((ILine) line.clone(), this.color);
    }
